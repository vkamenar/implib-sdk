...
object file and so on. ImpLib SDK provides a set of tools to solve this kind of problems. It is not necessary to understand the internal structure of an Import Library file to use these tools.
