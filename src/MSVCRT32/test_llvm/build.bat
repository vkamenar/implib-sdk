...
GOTO EXIT
:LLDLNKFOUND
echo Linking the Win32 executable to MSVCRT.DLL using the LLD linker
...
"%LLDLINK%" /SAFESEH:NO /SUBSYSTEM:CONSOLE /ENTRY:start test.o ..\..\..\lib\MSVCRT32\lld\msvcrt.lib
